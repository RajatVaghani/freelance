                ...
                <article class="content dashboard-page">
                    <section class="section">
                        <div class="row sameheight-container">
                            ...
                            <h2 class="page-header">Please select type to view:</h2>
                            <br/>
                            <div class="btn-group">
                                <a href="chart_accident.php" class="btn btn-info btn-lg">Accident</a>
                                <a href="chart_fire.php" class="btn btn-warning btn-lg">Fire</a>
                                <a href="chart_robbery.php" class="btn btn-danger btn-lg">Robbery</a>
                            </div>
